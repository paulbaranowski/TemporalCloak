...
**Demo 2** (Tornado HTTP, server→client): start `python temporal_cloak_web.py`, then `temporal-cloak decode http://localhost:8888/api/image`. The server also serves images at http://localhost:8888.
